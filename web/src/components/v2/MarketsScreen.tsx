...
import { CARDS, FILTERS, LEAGUES, SPORTS, sparkPoints, type MarketCard } from "@/lib/v2/markets";
...
export function MarketsScreen() {
  ...
  return (
    <div style={{ padding: "20px 26px 34px", display: "flex", flexDirection: "column", gap: 18 }}>
      ...
      >
        {cards.map((c) => (
          <Card key={c.fixtureId} card={c} onOpen={() => router.push(`/v2/match/${c.fixtureId}`)} />
        ))}
      </div>
